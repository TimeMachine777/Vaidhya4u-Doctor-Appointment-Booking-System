...
def classify_text(model,no_to_label,vectorizer):
    ...
    f=open(r'D:\BIT MESRA\Semester 5\Subjects\NLP\Project\Final Project\Files\Disease_DB.pkl','rb')
...
def booking(time,spec):
    ...
    f=open(r'D:\BIT MESRA\Semester 5\Subjects\NLP\Project\Final Project\Files\Disease_DB.pkl','wb')
